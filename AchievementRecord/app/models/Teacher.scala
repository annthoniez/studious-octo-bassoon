...
/**
  ...
  */
case class Teacher(teacher_id: Username, username: String, th_prename: String, th_name: String, en_prename: String, en_name: String, status_id: Int, mobile: String, email: String, acc: Option[Account] = None, stat: Option[Status] = None)
